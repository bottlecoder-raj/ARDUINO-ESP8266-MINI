<h3>Cammand to upload code via Arduino using Isp. Upload code in arduino as arduino as isp and then upload your code for 8051 in terminal running the command mentioned below.</h3>
